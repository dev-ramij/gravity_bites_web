                                                ...
                                                <div style={{ position: "relative" }}>
                                                    <div className='coupon-card send-bank'>
                                                        <div className='category-veg'>
                                                            <FormControl>
                                                                <FormLabel id="demo-row-radio-buttons-group-label">Veg/Non-veg</FormLabel>
                                                                <RadioGroup
                                                                    row
                                                                    aria-labelledby="demo-row-radio-buttons-group-label"
                                                                    name="row-radio-buttons-group"
                                                                    className='select-veg'
                                                                >
                                                        ...
                                                        <Row className='mb-4'>
                                                            <Col sm={12}>
                                                                ...
                                                                <div className="d-create-file" >
                                                                    <img style={{ height: '100px', width: '100px' }} id="image" className="object-cover w-full h-32" src={file} />
                                                        ...
                                                        <Row>
                                                            ...
                                                            <Col md={6}>
                                                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                                                    <TextField fullWidth label="Product Name" id="outlined-basic" variant="outlined" className='coupon-text' />
                                                                </Form.Group>
                                                            </Col>
                                                        </Row>
                                                        <Row>
                                                            ...
                                                            <Col md={6}>
                                                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                                                    <TextField fullWidth placeholder='$' id="outlined-basic" variant="outlined" className='coupon-text' />
                                                                </Form.Group>
                                                            </Col>
                                                        </Row>
                                                ...
                                                <div style={{ position: "relative" }} className="mt-4">
                                                    ...
                                                    <h2 className='title mb-3'>Add specification</h2>
                                                        <Row>
                                                            ...
                                                            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                                                    <TextField placeholder='Add' fullWidth id="outlined-basic" variant="outlined" className='coupon-text' />
                                                                </Form.Group>
                                                            </Col>
                                                            <Col md={6}>
                                                            <Form.Label>Price</Form.Label>
                                                                ...
                                                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                                                    <TextField placeholder='$3' fullWidth id="outlined-basic" variant="outlined" className='coupon-text' />
                                                                </Form.Group>
                                                            </Col>
                                                        </Row>
                                                         <div className='add-prosducts'>
                                                         <h4><i class="fa fa-plus" aria-hidden="true"></i>ADD MORE OPTIONS</h4>
                                                         </div>
